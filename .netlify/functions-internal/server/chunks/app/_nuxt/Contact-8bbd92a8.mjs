import __nuxt_component_0 from './GoogleMap-1e54c878.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_GoogleMap = __nuxt_component_0;
  const _component_PrimaryButton = _sfc_main$1;
  _push(`<main${ssrRenderAttrs(mergeProps({ class: "min-h-[calc(100vh-160px)]" }, _attrs))}><div class="grid lg:grid-cols-[2fr 1fr] min-h-[calc(100vh-160px)] items-center gap-[70px] max-w-[1440px] mx-auto"><div class="col-start-1 border border-[#B2896B] p-[10px] justify-self-end w-[690px] h-[400px]">`);
...
//# sourceMappingURL=Contact-8bbd92a8.mjs.map
