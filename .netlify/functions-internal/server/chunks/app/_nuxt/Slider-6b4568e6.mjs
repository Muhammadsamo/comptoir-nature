...
import { defineComponent, onUpdated, inject, ref, onMounted, onBeforeUnmount, watch, provide, computed, openBlock, createElementBlock, createElementVNode, renderSlot, resolveComponent, createBlock, resolveDynamicComponent, withCtx, unref, mergeProps, createVNode, Fragment, renderList, useSSRContext } from 'vue';
                  ...
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_NuxtLink, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<img${ssrRenderAttr("src", slide.img)} alt="Hero Slider image" width="510" height="367"${_scopeId3}>`);
                        } else {
                          return [
                            createVNode("img", {
                              src: slide.img,
...
//# sourceMappingURL=Slider-6b4568e6.mjs.map
